...
static const struct cpg_core_clk r8a7795_core_clks[] __initconst = {
	...
	DEF_GEN3_SD("sd0",      R8A7795_CLK_SD0,   CLK_PLL1_DIV4, 0x0074),
	DEF_GEN3_SD("sd1",      R8A7795_CLK_SD1,   CLK_PLL1_DIV4, 0x0078),
	DEF_GEN3_SD("sd2",      R8A7795_CLK_SD2,   CLK_PLL1_DIV4, 0x0268),
	DEF_GEN3_SD("sd3",      R8A7795_CLK_SD3,   CLK_PLL1_DIV4, 0x026c),
...
static const struct mssr_mod_clk r8a7795_mod_clks[] __initconst = {
	DEF_MOD("stb",			 104,	R8A7795_CLK_S2D1),
	DEF_MOD("3dge",			 112,	R8A7795_CLK_ZG),
	DEF_MOD("fdp2",			 117,	R8A7795_CLK_S2D1),
